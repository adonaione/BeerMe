...
// Callback function for fundBreweries that will accept brewery data and insert into the display table
function displayBreweries(data){
    ...
    thead.append(tr) // add the table row as a child to the table header
...
// Helper Fucntion for creating a new data cell for a table row
